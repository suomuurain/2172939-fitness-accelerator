...
},{"./modules/form-validate/form":3,"./modules/jury-swiper":9,"./modules/reviews-swiper":10,"./modules/video":11,"./utils/ios-vh-fix":13,"./vendor/accordions/init-accordion":15,"./vendor/tabs/init-tabs":17}],2:[function(require,module,exports){
"use strict";
...
var swiperJury = exports.swiperJury = new _swiper.default('.jury__swiper', {
  // Optional parameters
  loop: true,
  breakpoints: {
    320: {
